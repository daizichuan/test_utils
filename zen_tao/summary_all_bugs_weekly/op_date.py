...
class op_date(object):
    ...
    def week_get(self,d):
        ...
        this_week_end = d + datetime.timedelta(days=6 - d.weekday())

        date_from = datetime.datetime(this_week_start.year, this_week_start.month, this_week_start.day, 0, 0, 0)
        date_to = datetime.datetime(this_week_end.year, this_week_end.month, this_week_end.day, 23, 59, 59)
